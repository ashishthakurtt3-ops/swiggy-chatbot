...
def get_answer(vectorstore, question):
    ...
    prompt = PromptTemplate.from_template(
        """You are an assistant for question-answering tasks about the Swiggy Annual Report FY 2023-24.
Use only the context below to answer. If the answer is not in the context, say you don't know based on the report. Do not make up information.
